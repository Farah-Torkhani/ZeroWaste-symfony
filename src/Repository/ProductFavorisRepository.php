...
/**
 * @extends ServiceEntityRepository<ProductFavoris>
 *
...
class ProductFavorisRepository extends ServiceEntityRepository
{
    ...
    public function add(ProductFavoris $entity, bool $flush = false): void
    {
    ...
    public function remove(ProductFavoris $entity, bool $flush = false): void
    {
...
//    /**
//     * @return ProductFavoris[] Returns an array of ProductFavoris objects
//     */
...
//    public function findOneBySomeField($value): ?ProductFavoris
//    {
//        return $this->createQueryBuilder('p')
//            ->andWhere('p.exampleField = :val')
//            ->setParameter('val', $value)
